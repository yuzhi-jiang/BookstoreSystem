...
import com.example.BookstoreSystem.shiro.ApplicationContextHolder;
...
public class JwtUtil {
    ...
    public static String createToken(String userId, String userName, String[] roles) {
        try {
            ...
            LogUtil.info("过期时间为" + date.getTime());
            LogUtil.info("过期时间为" + jwtProperties.getExpire() * 1000);
            Algorithm algorithm = Algorithm.HMAC512(jwtProperties.getSecret());
            return JWT.create()
